...
define('spaircorp-ui/components/config-decision-control', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({

    controlTypeOptions: ['Radio', 'List'],
...
define('spaircorp-ui/components/config-text-control', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({});
});
...
define('spaircorp-ui/components/ember-wormhole', ['exports', 'ember-wormhole/components/ember-wormhole'], function (exports, _emberWormholeComponentsEmberWormhole) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
define('spaircorp-ui/components/script-instance', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    canAdvance: _ember['default'].computed('currentNode.controls.@each.answer', function () {
      var pendingMandatoryControls = this.get('currentNode.controls').filter(function (control) {
        return control.mandatory || control.branch;
      }).filter(function (item) {
        return _ember['default'].isBlank(item.answer);
      });

      return pendingMandatoryControls.length > 0;
    }),

    didInsertElement: function didInsertElement() {
      // Clone the diagram because we mutate it for settingn the answers
      var clone = JSON.parse(JSON.stringify(this.get('script.diagram')));
      this.set('diagram', clone);

      var startNode = clone.nodes.findBy('type', 'start');
    ...
    actions: {
      advance: function advance(currentNode, previousNode) {
        if (currentNode.type === 'start') {
          var exitEdge = this.get('diagram.edges').findBy('source', currentNode.id);
          var nextNode = this.get('diagram.nodes').findBy('id', exitEdge.target);
          ...
          var exitEdges = this.get('diagram.edges').filterBy('source', currentNode.id);

          // Match by user entry
          var branchingControl = previousNode.controls.findBy('branch', true);
          var exitEdge = this.get('diagram.edges').findBy('data.label', branchingControl.answer); // FIXME ************************** HARD CODED
    ...
    actions: {
      add: function add(obj /*, ops*/) {
        ...
        if (obj.origin === 'control-toolbox') {
          if (obj.type === 'text') {
            this.get('model.obj.data.controls').push({
              type: obj.type,
...
define('spaircorp-ui/initializers/ember-drag-drop-polyfill', ['exports', 'ember-drag-drop-polyfill/initializers/ember-drag-drop-polyfill'], function (exports, _emberDragDropPolyfillInitializersEmberDragDropPolyfill) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
      return _emberDragDropPolyfillInitializersEmberDragDropPolyfill['default'];
    }
  });
  Object.defineProperty(exports, 'initialize', {
    enumerable: true,
    get: function get() {
      return _emberDragDropPolyfillInitializersEmberDragDropPolyfill.initialize;
    }
  });
});
...
define('spaircorp-ui/mirage/factories/script', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  exports['default'] = _emberCliMirage.Factory.extend({
    ...
    status: 'Online',
    url: function url(i) {
      return '/customer/script/' + (i + 1);
    },
    diagram: {}
  });
});
define('spaircorp-ui/mirage/factories/user', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  exports['default'] = _emberCliMirage.Factory.extend({});
});
define('spaircorp-ui/mirage/models/script', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  exports['default'] = _emberCliMirage.Model.extend({});
});
define('spaircorp-ui/mirage/models/user', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  exports['default'] = _emberCliMirage.Model.extend({});
});
...
define('spaircorp-ui/mirage/serializers/user', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  exports['default'] = _emberCliMirage.JSONAPISerializer.extend({});
});
...
define('spaircorp-ui/models/user', ['exports', 'ember-data'], function (exports, _emberData) {
  exports['default'] = _emberData['default'].Model.extend({
...
define('spaircorp-ui/routes/admin', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    ...
    model: function model() {
      return this.store.findRecord('user', 1); // TODO FIXME
    }
  ...
  exports["default"] = _ember["default"].Route.extend({
    ...
    actions: {
      ...
      onEditNode: function onEditNode(params) {
        ...
        if (type === 'process') {
          // const process = Ember.Object.create({
          var _process = {
      ...
      test: function test() {
        this.transitionTo('admin.scripts.edit.test', this.modelFor(this.routeName));
...
define('spaircorp-ui/routes/admin/scripts/edit/process/edit', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    ...
    afterModel: function afterModel(model) {
      ...
      // If no controls object has yet been generated - create it
      if (!_ember['default'].isArray(model.obj.data.controls)) {
        model.obj.data.controls = [];
      }

      // Inject the appropriate branching control
      var decisionConnection = model.obj.getSourceEdges().find(function (item) {
        return item.target && item.target.getType() === 'decision';
      });
        ...
        (function () {
          ...
          decisionConnection.target.getSourceEdges().forEach(function (item) {
            options.push({
              ...
              targetLabel: item.target.data.text
            });
          });
...
//   }
// }
define('spaircorp-ui/routes/admin/scripts/edit/test', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({

    model: function model() {
      return this.modelFor('admin.scripts.edit');
    },

    actions: {
      save: function save(script, diagramWithAnswers) {
        debugger;
      },

      end: function end(script) {
        this.transitionTo('admin.scripts.edit', this.modelFor(this.routeName));
      }
    }
  });
});
...
define('spaircorp-ui/routes/customer/script', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
...
define("spaircorp-ui/templates/admin/scripts/edit", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "D5YxNpk8", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-group\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"for\",\"script-name\"],[\"flush-element\"],[\"text\",\"Name\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"one-way-input\"],[[\"get\",[\"model\",\"name\"]]],[[\"placeholder\",\"update\",\"class\"],[\"Name\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"model\",\"name\"]]],null]],null],\"form-control\"]]],false],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"text\",\"\\n\"],[\"open-element\",\"hr\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"block\",[\"jsplumb-toolkit\"],null,[[\"data\",\"on-dbl-click-edge\",\"on-edit-node\",\"before-drop\",\"save-url\"],[[\"helper\",[\"readonly\"],[[\"get\",[\"model\",\"diagram\"]]],null],[\"helper\",[\"route-action\"],[\"onDblClickEdge\"],null],[\"helper\",[\"route-action\"],[\"onEditNode\"],null],[\"helper\",[\"route-action\"],[\"beforeDrop\"],null],[\"helper\",[\"readonly\"],[[\"get\",[\"saveUrl\"]]],null]]],0],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"hr\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"async-button\"],null,[[\"class\",\"action\",\"default\",\"pending\"],[\"btn btn-default col-xs-6\",[\"helper\",[\"route-action\"],[\"test\",[\"get\",[\"model\"]]],null],\"Test\",\"Please wait...\"]]],false],[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"async-button\"],null,[[\"class\",\"action\",\"default\",\"pending\"],[\"btn btn-primary col-xs-6\",[\"helper\",[\"route-action\"],[\"save\",[\"get\",[\"model\"]]],null],\"Save\",\"Saving...\"]]],false],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\\n\\n\\n\\n\"],[\"text\",\"\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\n\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/admin/scripts/edit.hbs" } });
});
define("spaircorp-ui/templates/admin/scripts/edit/process/edit", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "AmxSMwVE", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"animated slideInRight diagram-overlay\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-danger\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"route-action\"],[\"close\"],null],null],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-times fa-2x\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-4\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"style\",\"padding-left:3px; overflow-y: auto; height: 500px;\"],[\"flush-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Name: \"],[\"close-element\"],[\"text\",\"\\n        \"],[\"append\",[\"helper\",[\"one-way-input\"],[[\"get\",[\"model\",\"obj\",\"data\",\"text\"]]],[[\"update\",\"class\"],[[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"model\",\"obj\",\"data\",\"text\"]]],null]],null],\"form-control\"]]],false],[\"text\",\"\\n\\n        \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Description: \"],[\"close-element\"],[\"text\",\"\\n        \"],[\"append\",[\"helper\",[\"one-way-textarea\"],[[\"get\",[\"model\",\"obj\",\"data\",\"description\"]]],[[\"update\",\"class\"],[[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"model\",\"obj\",\"data\",\"description\"]]],null]],null],\"form-control\"]]],false],[\"text\",\"\\n\\n        \"],[\"open-element\",\"h4\",[]],[\"flush-element\"],[\"text\",\"Controls\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"text\",\"PlainText\",\"control-toolbox\"]]]]],14],[\"text\",\"        \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"input\",\"Textbox\",\"control-toolbox\"]]]]],13],[\"text\",\"        \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"input\",\"Textarea\",\"control-toolbox\"]]]]],12],[\"text\",\"        \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"input\",\"Currency\",\"control-toolbox\"]]]]],11],[\"text\",\"        \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"input\",\"Date\",\"control-toolbox\"]]]]],10],[\"text\",\"        \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"input\",\"Number\",\"control-toolbox\"]]]]],9],[\"text\",\"        \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"options\",\"List\",\"control-toolbox\"]]]]],8],[\"text\",\"        \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"options\",\"Checkbox\",\"control-toolbox\"]]]]],7],[\"text\",\"        \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object\"],null,[[\"content\"],[[\"helper\",[\"hash\"],null,[[\"type\",\"controlType\",\"origin\"],[\"options\",\"Radio\",\"control-toolbox\"]]]]],6],[\"text\",\"      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-8\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"draggable-object-target\"],null,[[\"action\",\"class\"],[\"add\",\"control-drop-area\"]],5],[\"text\",\"    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\n\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"                    \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-times pull-right btn\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"action\"],[[\"get\",[null]],\"delete\",[\"get\",[\"control\"]]],null],null],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[],\"locals\":[]},{\"statements\":[[\"text\",\"              \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"\"],[\"flush-element\"],[\"text\",\"\\n                \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-2x fa-th js-control-drag-handle\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"static-attr\",\"style\",\"cursor: move\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"helper\",[\"eq\"],[[\"get\",[\"control\",\"type\"]],\"decision\"],null]],null,1,0],[\"text\",\"                \"],[\"close-element\"],[\"text\",\"\\n              \"],[\"close-element\"],[\"text\",\"\\n              \"],[\"append\",[\"helper\",[\"component\"],[[\"helper\",[\"concat\"],[\"config-\",[\"get\",[\"control\",\"type\"]],\"-control\"],null]],[[\"control\"],[[\"get\",[\"control\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"draggable-object\"],null,[[\"class\",\"content\",\"isSortable\",\"sortingScope\",\"dragHandle\"],[\"control-group\",[\"get\",[\"control\"]],true,\"sortingGroup\",\".js-control-drag-handle\"]],2]],\"locals\":[\"control\"]},{\"statements\":[[\"text\",\" \"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\",\"obj\",\"data\",\"controls\"]]],null,3]],\"locals\":[]},{\"statements\":[[\"text\",\"        \"],[\"block\",[\"sortable-objects\"],null,[[\"sortableObjectList\",\"enableSort\",\"useSwap\",\"sortingScope\"],[[\"get\",[\"model\",\"obj\",\"data\",\"controls\"]],true,true,\"sortingGroup\"]],4]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-stop-circle-o\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Radio\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-check-square\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Checkbox\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-list-ol\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" List\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-square\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"text\",\"123\"],[\"close-element\"],[\"text\",\" Number\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-calendar\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Date\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-money\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Currency\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-text-height\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Textarea\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-text-width\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Textbox\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"form-control dragable\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-info-circle\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Free Text\\n          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/admin/scripts/edit/process/edit.hbs" } });
});
define("spaircorp-ui/templates/admin/scripts/edit/test", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "VFMYU6fi", "block": "{\"statements\":[[\"block\",[\"ember-wormhole\"],null,[[\"to\"],[\"modal\"]],0],[\"text\",\"\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"modal-backdrop\"],[\"static-attr\",\"style\",\"width: 100%;height: 100%; opacity: 0.5;\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"modal show\"],[\"static-attr\",\"tabindex\",\"-1\"],[\"static-attr\",\"role\",\"dialog\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"modal-dialog\"],[\"static-attr\",\"role\",\"document\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"modal-content\"],[\"flush-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"modal-header\"],[\"flush-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"type\",\"button\"],[\"static-attr\",\"class\",\"close\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"route-action\"],[\"end\"],null],null],[\"flush-element\"],[\"open-element\",\"span\",[]],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"text\",\"×\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"h4\",[]],[\"static-attr\",\"class\",\"modal-title\"],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-caret-right\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" \"],[\"append\",[\"unknown\",[\"model\",\"name\"]],false],[\"text\",\" \"],[\"open-element\",\"small\",[]],[\"flush-element\"],[\"text\",\"(DEMO)\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"modal-body\"],[\"flush-element\"],[\"text\",\"\\n          \"],[\"append\",[\"helper\",[\"script-instance\"],null,[[\"script\",\"onFinish\",\"onEnd\"],[[\"get\",[\"model\"]],[\"helper\",[\"route-action\"],[\"save\"],null],[\"helper\",[\"route-action\"],[\"end\"],null]]]],false],[\"text\",\"\\n        \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/admin/scripts/edit/test.hbs" } });
});
define("spaircorp-ui/templates/admin/scripts/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "pevkKBrR", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-success\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"route-action\"],[\"create\"],null],null],[\"flush-element\"],[\"text\",\"New Script\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"table\",[]],[\"static-attr\",\"class\",\"table table-striped border-left table-hover\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"thead\",[]],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"tr\",[]],[\"flush-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"th\",[]],[\"flush-element\"],[\"text\",\"Script\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"th\",[]],[\"flush-element\"],[\"text\",\"Date\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"th\",[]],[\"flush-element\"],[\"text\",\"Status\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"th\",[]],[\"flush-element\"],[\"text\",\"URL\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"th\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"tbody\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\"]]],null,1],[\"text\",\"      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-external-link\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Start Script\"]],\"locals\":[]},{\"statements\":[[\"text\",\"        \"],[\"open-element\",\"tr\",[]],[\"flush-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"td\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"script\",\"name\"]],false],[\"close-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"td\",[]],[\"flush-element\"],[\"append\",[\"helper\",[\"moment-format\"],[[\"get\",[\"script\",\"date\"]],\"DD-MM-YYYY\"],null],false],[\"close-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"td\",[]],[\"flush-element\"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"label label-success\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"script\",\"status\"]],false],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"td\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"customer.script\",[\"get\",[\"script\",\"id\"]]],[[\"target\",\"class\"],[\"_blank\",\"btn btn-primary\"]],0],[\"close-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"td\",[]],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"pull-right\"],[\"flush-element\"],[\"text\",\"\\n              \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-primary\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"route-action\"],[\"edit\",[\"get\",[\"script\"]]],null],null],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-pencil\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Edit\"],[\"close-element\"],[\"text\",\"\\n              \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-danger\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"route-action\"],[\"delete\",[\"get\",[\"script\"]]],null],null],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-trash\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" Delete\"],[\"close-element\"],[\"text\",\"\\n            \"],[\"close-element\"],[\"text\",\"\\n          \"],[\"close-element\"],[\"text\",\"\\n        \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"script\"]}],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/admin/scripts/index.hbs" } });
});
...
define("spaircorp-ui/templates/application", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "Fops4dFy", "block": "{\"statements\":[[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\\n\"],[\"append\",[\"helper\",[\"ember-notify\"],null,[[\"messageStyle\"],[\"bootstrap\"]]],false],[\"text\",\"\\n\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"id\",\"modal\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/application.hbs" } });
});
define("spaircorp-ui/templates/components/config-decision-control", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "bOTqjd35", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Control Type\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-select\"],[[\"get\",[\"control\",\"controlType\"]]],[[\"class\",\"options\",\"update\"],[\"form-control\",[\"get\",[\"controlTypeOptions\"]],[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"controlType\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Label\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-input\"],[[\"get\",[\"control\",\"text\"]]],[[\"class\",\"update\"],[\"form-control\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"text\"]]],null]],null]]]],false],[\"text\",\"  \"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-6\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Options\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"control\",\"options\"]]],null,0],[\"text\",\"  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"      \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"label label-primary\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"option\",\"label\"]],false],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-arrow-right\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"label label-success\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"option\",\"targetLabel\"]],false],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"option\"]}],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/components/config-decision-control.hbs" } });
});
define("spaircorp-ui/templates/components/config-input-control", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "mdUv2c7p", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-2\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Control Type\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-select\"],[[\"get\",[\"control\",\"controlType\"]]],[[\"class\",\"options\",\"update\"],[\"form-control\",[\"get\",[\"controlTypeOptions\"]],[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"controlType\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Label\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-input\"],[[\"get\",[\"control\",\"label\"]]],[[\"class\",\"update\"],[\"form-control\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"label\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Default\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-input\"],[[\"get\",[\"control\",\"default\"]]],[[\"class\",\"update\"],[\"form-control\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"default\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-1\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Mandatory\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-checkbox\"],[[\"get\",[\"control\",\"mandatory\"]]],[[\"class\",\"update\"],[\"form-control\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"mandatory\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/components/config-input-control.hbs" } });
});
define("spaircorp-ui/templates/components/config-options-control", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "zlXG6W0J", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-2\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Control Type\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-select\"],[[\"get\",[\"control\",\"controlType\"]]],[[\"class\",\"options\",\"update\"],[\"form-control\",[\"get\",[\"controlTypeOptions\"]],[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"controlType\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Label\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-input\"],[[\"get\",[\"control\",\"label\"]]],[[\"class\",\"update\"],[\"form-control\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"label\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Options\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-textarea\"],[[\"get\",[\"control\",\"options\"]]],[[\"rows\",\"class\",\"placeholder\",\"update\"],[\"5\",\"form-control\",\"comma separated list\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"options\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Default\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-select\"],[[\"get\",[\"control\",\"default\"]]],[[\"options\",\"class\",\"update\"],[[\"get\",[\"options\"]],\"form-control\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"default\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-1\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Mandatory\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-checkbox\"],[[\"get\",[\"control\",\"mandatory\"]]],[[\"class\",\"update\"],[\"form-control\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"mandatory\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/components/config-options-control.hbs" } });
});
define("spaircorp-ui/templates/components/config-text-control", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "JQv7pDOy", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"class\",\"control-label\"],[\"flush-element\"],[\"text\",\"Text\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"one-way-textarea\"],[[\"get\",[\"control\",\"text\"]]],[[\"class\",\"update\"],[\"form-control\",[\"helper\",[\"action\"],[[\"get\",[null]],[\"helper\",[\"mut\"],[[\"get\",[\"control\",\"text\"]]],null]],null]]]],false],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/components/config-text-control.hbs" } });
});
...
define("spaircorp-ui/templates/customer", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "hHO9qMHq", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"container-fluid\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"],[\"close-element\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/customer.hbs" } });
});
define("spaircorp-ui/templates/customer/script", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "YNvX15Un", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"style\",\"max-width: 800px; margin: auto; width: 50%;\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"data:image/png;base64,\"],[\"static-attr\",\"height\",\"90\"],[\"static-attr\",\"style\",\"margin-left:-7px;margin-right:-8px\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"page-header\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"h1\",[]],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-caret-right\"],[\"static-attr\",\"aria-hidden\",\"true\"],[\"flush-element\"],[\"close-element\"],[\"text\",\" \"],[\"append\",[\"unknown\",[\"model\",\"name\"]],false],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"append\",[\"helper\",[\"script-instance\"],null,[[\"script\",\"onFinish\",\"onEnd\"],[[\"get\",[\"model\"]],[\"helper\",[\"route-action\"],[\"save\"],null],[\"helper\",[\"route-action\"],[\"end\"],null]]]],false],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "spaircorp-ui/templates/customer/script.hbs" } });
});
...
define('spaircorp-ui/tests/mirage/mirage/factories/user.lint-test', ['exports'], function (exports) {
  QUnit.module('ESLint - mirage/factories/user.js');
  QUnit.test('should pass ESLint', function (assert) {
    assert.expect(1);
...
define('spaircorp-ui/tests/mirage/mirage/models/user.lint-test', ['exports'], function (exports) {
...
define('spaircorp-ui/tests/mirage/mirage/scenarios/default.lint-test', ['exports'], function (exports) {
  ...
  QUnit.test('should pass ESLint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'mirage/scenarios/default.js should pass ESLint.\n9:9  - \'user1\' is assigned a value but never used. (no-unused-vars)\n15:9  - \'script1\' is assigned a value but never used. (no-unused-vars)\n31:9  - \'script2\' is assigned a value but never used. (no-unused-vars)\n184:9  - \'script3\' is assigned a value but never used. (no-unused-vars)');
  });
});
...
define('spaircorp-ui/tests/mirage/mirage/serializers/user.lint-test', ['exports'], function (exports) {
  QUnit.module('ESLint - mirage/serializers/user.js');
  QUnit.test('should pass ESLint', function (assert) {
    assert.expect(1);
...
if (!runningTests) {
  require("spaircorp-ui/app")["default"].create({"name":"spaircorp-ui","version":"0.0.0+75984fe8"});
}
