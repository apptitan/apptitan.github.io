...
define('spaircorp-ui/controllers/admin/scripts/edit', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    ...
    hasStartNode: _ember['default'].computed('model.steps.@each', function () {
      return this.get('model.steps').filterBy('stereotype', 'start');
    })
    // endpoints: [{
    //   isSource: true,
    //   maxConnections: -1,
...
define('spaircorp-ui/mirage/models/script', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  exports['default'] = _emberCliMirage.Model.extend({
    steps: (0, _emberCliMirage.hasMany)(),
...
define('spaircorp-ui/mirage/scenarios/default', ['exports'], function (exports) {
  exports['default'] = function (server) {
    ...
    */
    ...
    /*
      const connection2 = server.create('connection', {
    ...
    */
    ...
    //const script2 = server.create('script');
    //const script3 = server.create('script');
  };
});
...
define('spaircorp-ui/models/checkbox-control', ['exports', 'spaircorp-ui/models/control'], function (exports, _spaircorpUiModelsControl) {
...
// import DS from 'ember-data';
define('spaircorp-ui/models/list-control', ['exports', 'spaircorp-ui/models/control'], function (exports, _spaircorpUiModelsControl) {
  exports['default'] = _spaircorpUiModelsControl['default'].extend({
    controlType: 'list'
  });
});
...
define('spaircorp-ui/models/radio-control', ['exports', 'spaircorp-ui/models/control'], function (exports, _spaircorpUiModelsControl) {
  exports['default'] = _spaircorpUiModelsControl['default'].extend({
    title: 'Radio',
    controlType: 'radio'
  });
...
if (!runningTests) {
  require("spaircorp-ui/app")["default"].create({"name":"spaircorp-ui","version":"0.0.0+a638ca6d"});
}
