...
define('ember-asset-loader/test-support/loaded-asset-state', ['exports', 'ember'], function (exports, _ember) {
  'use strict';
  ...
  var cachedRequireEntries = undefined;
  var cachedScriptTags = undefined;
  var cachedLinkTags = undefined;
  ...
  function resetLoadedAssetState() {
    _ember['default'].Logger.info('Resetting loaded asset state. This will attempt to restore the state of loaded assets to the last cached value. If an asset modified some global state, we cannot guarantee it will be reset. For more information see: https://github.com/trentmwillis/ember-asset-loader#resetting-test-state');

    var _getLoadedAssetState2 = getLoadedAssetState();

    var currentRequireEntries = _getLoadedAssetState2.requireEntries;
    var currentScriptTags = _getLoadedAssetState2.scripts;
    var currentLinkTags = _getLoadedAssetState2.links;
...
define('ember-asset-loader/test-support/preload-assets', ['exports', 'ember', 'ember-asset-loader/services/asset-loader'], function (exports, _ember, _emberAssetLoaderServicesAssetLoader) {
  'use strict';
  ...
  function preloadAssets(manifest) {
    var loader = _emberAssetLoaderServicesAssetLoader['default'].create();
